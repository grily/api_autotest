...
class TestKnowledgePoints():
    ...
    @pytest.mark.parametrize("req_params,desc,asert,resp,depend,run,story,jschema", get_params(ymldata, 'resourceAll'))
    def test_resourceAll(self, req_params, desc, asert, resp, depend, run, story, jschema):
